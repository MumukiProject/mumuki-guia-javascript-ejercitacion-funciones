it("Si hacemos dividir(2, 3) debería retornar 0.666666666666", function() {
  let resultado = dividir(2,3)
  assert.equal(resultado, 0.666666666666,`La división debería retornar 0.666666666666 pero fue ${resultado}`);
})
